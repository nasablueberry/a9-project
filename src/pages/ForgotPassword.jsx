        ...
        React.createElement("div", { className: "max-w-md w-full" },
            React.createElement("div", { className: "bg-white rounded-2xl shadow-xl p-8", "data-aos": "fade-up" },
                React.createElement("div", { className: "text-center mb-8" },
                    ...
                    React.createElement("h2", { className: "text-gray-900 mb-2" }, "Reset Password"),
                    React.createElement("p", { className: "text-gray-600" }, "Enter your email and we'll send you a link to reset your password")),
                React.createElement("form", { onSubmit: handleSubmit, className: "space-y-6" },
                    ...
                    React.createElement("button", { type: "submit", disabled: loading || isDemoMode, className: "w-full py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed" }, loading ? 'Sending...' : 'Reset Password')),
                React.createElement(Link, { to: "/login", className: "flex items-center justify-center gap-2 text-gray-600 hover:text-gray-900 mt-6" },
