...
function Menubar({ className, ...props }) {
    return (React.createElement(MenubarPrimitive.Root, { "data-slot": "menubar", className: cn("bg-background flex h-9 items-center gap-1 rounded-md border p-1 shadow-xs", className), ...props }));
}
...
function MenubarLabel({ className, inset, ...props }) {
    return (React.createElement(MenubarPrimitive.Label, { "data-slot": "menubar-label", "data-inset": inset, className: cn("px-2 py-1.5 text-sm font-medium data-[inset]:pl-8", className), ...props }));
}
function MenubarSeparator({ className, ...props }) {
    return (React.createElement(MenubarPrimitive.Separator, { "data-slot": "menubar-separator", className: cn("bg-border -mx-1 my-1 h-px", className), ...props }));
}
function MenubarShortcut({ className, ...props }) {
    return (React.createElement("span", { "data-slot": "menubar-shortcut", className: cn("text-muted-foreground ml-auto text-xs tracking-widest", className), ...props }));
}
