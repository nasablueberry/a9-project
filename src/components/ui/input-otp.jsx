...
function InputOTP({ className, containerClassName, ...props }) {
    return (React.createElement(OTPInput, { "data-slot": "input-otp", containerClassName: cn("flex items-center gap-2 has-disabled:opacity-50", containerClassName), className: cn("disabled:cursor-not-allowed", className), ...props }));
}
function InputOTPGroup({ className, ...props }) {
    return (React.createElement("div", { "data-slot": "input-otp-group", className: cn("flex items-center gap-1", className), ...props }));
}
