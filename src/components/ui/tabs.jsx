...
function Tabs({ className, ...props }) {
    return (React.createElement(TabsPrimitive.Root, { "data-slot": "tabs", className: cn("flex flex-col gap-2", className), ...props }));
}
function TabsList({ className, ...props }) {
    return (React.createElement(TabsPrimitive.List, { "data-slot": "tabs-list", className: cn("bg-muted text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-xl p-[3px] flex", className), ...props }));
}
...
function TabsContent({ className, ...props }) {
    return (React.createElement(TabsPrimitive.Content, { "data-slot": "tabs-content", className: cn("flex-1 outline-none", className), ...props }));
}
