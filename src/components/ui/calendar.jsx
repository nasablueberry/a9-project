...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
    return (React.createElement(DayPicker, { showOutsideDays: showOutsideDays, className: cn("p-3", className), classNames: {
            ...
            IconLeft: ({ className, ...props }) => (React.createElement(ChevronLeft, { className: cn("size-4", className), ...props })),
            IconRight: ({ className, ...props }) => (React.createElement(ChevronRight, { className: cn("size-4", className), ...props })),
        }, ...props }));
}
export { Calendar };
